...
//	}
	...
	public void setDropdown(String name, String txt) {
		Select dropdown = new Select(driver.findElement(By.name(name)));
		dropdown.selectByVisibleText(txt);
	}
	
	public void getElementByAttribute(String name, int idx) {
		WebElement elm = driver.findElement(By.xpath("//*[@data-name='"+name+"']"));
		WebElement gender = elm.findElements(By.tagName("span")).get(idx).findElement(By.tagName("input"));
		gender.click();
	}
